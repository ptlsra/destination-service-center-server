    ...
    function displayShipment(){
        ...
        $('#loadingModal').modal();
                ...
                if(currentStatus=="Shipment_Delivered_by_Road_Driver"){
                    ...
                    $('#pendingDispatchAdminContainer').append( `
                 ...
                 <span  id="shipmentTxId3" class="fontsizecustomnew margintx"> </span>
                  ...
                  <table class="table table-bordered marginleftcustom">
                    ...
                    <input type="submit" value="Confirm Arrival At Destination Center" class="btn adminBtn marginleftcustom" name="submitButton">
              ...
              <div class="vs animated slideInUp slower">
                  ...
                  <table class="table table-bordered marginleftcustom">
                    ...
                    <td colspan="2">
                    <select id="assigCityDriverForShipment" class="fullwidth" required>
                    </select></td>
                    ...
                    <input type="submit" value="Assign City Driver To Deliver Shipment" class="btn adminBtn marginleftcustom" name="submitButton">
              ...
              <div class="vs animated slideInUp slower">
                ...
                if(currentStatus=="Delivery_Receipt_created"){
              ...
              <div class="vs animated slideInUp slower">
                  ...
                  <table class="table table-bordered marginleftcustom">
                    ...
                    <td colspan="2">Shipment Image</td>
                    <td id="imageUploadedByRoadDriver" colspan="2"></td>
                    <td >Assign City Driver To Deliver Shipment</td>
                    <td  id="cityDriverForShipment">
              ...
              <div class="vs animated slideInUp slower">
                  ...
                  <table class="table table-bordered marginleftcustom">
                    ...
                    <tr>
                    <td colspan="2">Assign City Driver To Deliver Shipment</td>
                    <td colspan="2" id="cityDriverForShipment"></td>


                    <td colspan="2">Consignee Sign</td>
                    <td colspan="2" id="consigneeSign">True</td>
            ...
            function getShipmentDetailsForTable(){
                ...
                //    document.getElementById('bolId').innerHTML=response.billOfLadingId;
                    ...
                    document.getElementById('bolId').innerHTML= '<a href=bolDetails.html?bolId='+response.billOfLadingId+'>'+response.billOfLadingId;
